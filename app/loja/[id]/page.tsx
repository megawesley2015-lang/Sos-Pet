...
export async function generateMetadata({
  ...
  if (!data) return { title: { absolute: "Produto não encontrado · SOS Pet Aumigo" } };
  return {
    title: { absolute: `${data.name} · Loja SOS Pet Aumigo` },
      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-6 space-y-2">
              <div className="flex items-center gap-2 text-xs text-fg-subtle">
                ...
                <span>Produto selecionado pela equipe SOS Pet Aumigo</span>
              </div>
              <div className="flex items-center gap-2 text-xs text-fg-subtle">
        ...
        <div className="mt-12 rounded-2xl border border-brand-500/30 bg-brand-500/10 p-6 text-center">
          ...
          <p className="mt-1 text-sm text-fg-muted">
            Com o QR Code do SOS Pet Aumigo, qualquer pessoa que encontrar seu pet pode ver seu contato na hora.
          </p>
          <Link
            href="/plaquinha"
