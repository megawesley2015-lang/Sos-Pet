...
import { LayoutDashboard, Building2, Handshake, PawPrint, ShieldCheck, Eye, QrCode, ShoppingBag, Camera } from "lucide-react";
...
export default async function AdminLayout({
  ...
  const navItems = [
    ...
    { href: "/admin/sentinela", label: "Sentinela", icon: Camera },
