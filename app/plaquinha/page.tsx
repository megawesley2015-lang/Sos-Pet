...
export const metadata = {
  ...
  openGraph: {
    title: "Plaquinha de Identificação QR Code · SOS Pet Aumigo",
    description:
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "O QR leva para o perfil do seu pet no SOS Pet Aumigo, que você pode atualizar a qualquer hora.",
  },
  {
    icon: Siren,
