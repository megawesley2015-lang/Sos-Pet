# Estratégia — Parceiros Santos Jun/26
...
### TOPO — Reconhecimento (Dias 1 a 7)

```
Canal:    Visita presencial ao balcao + WhatsApp direto para o dono
Mensagem: "Quantas vezes por semana alguem chega aqui perguntando
           sobre um pet perdido? Agora voce tem o que dar pra eles."
Meta:     Abertura de conversa com o decisor (dono ou gerente)
          — nao venda, so curiosidade ativada
```

O pet shop ja conhece a dor. A pergunta de abertura nao vende nada — apenas nomeia algo que o atendente vive toda semana sem ferramenta para resolver. Essa pergunta gera concordancia imediata e abre o espaco para o proximo passo.

### MEIO — Consideracao (Dias 3 a 14)
...
A barreira principal no fundo e tempo e burocracia — o dono de pet shop em Santos nao tem gerente de marketing. A proposta precisa ser zerada em atrito: sem formulario longo, sem reuniao, sem contrato. O cadastro e feito em 5 minutos com a gente ao lado.

### POS-PARCERIA — Fidelizacao e ativacao (Mes 1 em diante)

```
Canal:    WhatsApp direto com o responsavel do pet shop
...
O pos-parceria e o canal de aquisicao do proximo parceiro. Cada post de reencontro co-branded com um pet shop e a melhor evidencia para convencer o seguinte. Manter o parceiro ativo exige apenas uma mensagem por ocorrencia — sem reunioes, sem relatorio.

---

## Sequencia de abordagem (3 etapas)

### Etapa 1 — Ativacao presencial (Dia 1 a 3)
...
> "A gente criou uma ferramenta pra isso — e gratis pro tutor e gratis pra voce. Posso te mostrar em 3 minutos como funciona?"

Se o dono nao estiver disponivel: pedir o WhatsApp do responsavel e combinar horario. Nao deixar material fisico sem contato direto — panfleto sem follow-up nao converte.

**Meta da Etapa 1:** Contato direto com o decisor em pelo menos 5 dos 8 alvos prioritarios.

---

### Etapa 2 — Demonstracao pelo WhatsApp (Dia 4 a 7)
...
### Etapa 3 — Fechamento e ativacao (Dia 8 a 14)

**O que fazer:**  
Ligacao rapida (objetivo: menos de 5 minutos) para tirar duvidas e coletar os dados do cadastro na hora. Nao agendar reuniao — o cadastro e feito durante a ligacao ou imediatamente apos.
...
**Meta da Etapa 3:** 5 pet shops cadastrados no diretorio ate o dia 14.

---

## Priorizacao de alvos

### Tier 1 — Abordar primeiro (Semana 1)

| Pet Shop | Por que primeiro | Angulo dominante |
|---|---|---|
| Molecão (Aparecida) | 14k seguidores, independente, desde 1993 — decisor acessivel, autonomia total, capacidade de amplificar o co-post | Angulo 3 (causa + marca) |
| Dog Love (Gonzaga) | 10k seguidores, posicionamento diferenciado (low-stress, bem-estar), perfil de dono com identidade de marca — mais receptivo a causa | Angulo 3 (causa + marca) |
| Emporio Animal Canal 2 (Vila Belmiro) | Rede mais tradicional de Santos, 18 anos de mercado, 5 unidades — fechar uma fecha as outras 4 | Angulo 1 (heroi no balcao) |
| Republica dos Bichos (Gonzaga) | Duas unidades, presenca digital ativa, perfil de dono engajado em causa animal | Angulo 1 + 3 combinados |

### Tier 2 — Abordar na Semana 2

| Pet Shop | Por que segundo | Angulo dominante |
|---|---|---|
| Petland Embare (Embare) | Franqueado com Instagram proprio (5,6k) e autonomia editorial — receptivo a conteudo diferenciado | Angulo 3 (causa + marca) |
| Petland Boqueirao (Boqueirao) | Maior following do grupo Petland Santos (4,7k + 3k seguindo) — usa estrategia de crescimento ativo | Angulo 3 (marca) |
| Petland Canal 6 (Ponta da Praia) | Regiao de alta circulacao de turistas com pets — caso de uso forte | Angulo 1 (heroi no balcao) |
| Royal Sandy (Marape) | Funciona 24h — unico ponto de apoio fora do horario comercial | Angulo 1 (heroi no balcao) |

### Por que Petz fica fora do Tier 1

Petz Ana Costa e Petz Macuco sao unidades de rede nacional com decisao centralizada. Parceria com franquias de rede nacional exige aprovacao da matriz — o ciclo de decisao e 3-5x mais longo e a probabilidade de "nao" e maior no nivel local. Abordar apenas apos ter 5+ parceiros independentes como prova social.

---

## Plano de 30 dias

### Semana 1 (Dias 1 a 7) — Lancamento presencial

**Objetivo:** Fazer contato direto com os 4 alvos Tier 1 e iniciar sequencia de abordagem.

- **Dia 1-2:** Visitas presenciais a Molecao (Aparecida) e Dog Love (Gonzaga). Foco em criar relacionamento, nao fechar. Levar o mock impresso do perfil no diretorio.
- **Dia 3:** Visita presencial a Emporio Animal Canal 2 (Vila Belmiro). Se o dono nao estiver, pegar o WhatsApp do responsavel.
- **Dia 4:** Visita presencial a Republica dos Bichos (Gonzaga). Focar na pauta de causa animal — perfil mais receptivo a este angulo.
- **Dia 5-7:** Enviar sequencia de WhatsApp (Etapa 2) para todos os contatos coletados. Monitorar respostas e responder em menos de 2 horas.

**Metrica de sucesso da Semana 1:** 4 contatos diretos com decisores + 2 respostas positivas no WhatsApp.

---

### Semana 2 (Dias 8 a 14) — Fechamento Tier 1 + inicio Tier 2

**Objetivo:** Converter pelo menos 3 dos 4 alvos Tier 1 em parceiros cadastrados.
...
### Semana 4 (Dias 22 a 30) — Consolidacao e escala

**Objetivo:** Atingir 8 parceiros, publicar 2 posts de co-branding com engajamento real e documentar o processo para replica em outras cidades.

- **Dia 22-23:** Publicar segundo post de co-branding. Marcar o pet shop parceiro. Monitorar engajamento e capturar o numero para usar como argumento B2B.
- **Dia 24-25:** Fechar os 2 parceiros restantes que ainda estao em negociacao. Usar o engajamento dos posts como prova de resultado.
- **Dia 26-27:** Abordar Planeta Animal (Embate, nicho de aquarismo/repteis) — perfil diferente mas com clientela de nicho fiel.
- **Dia 28-30:** Relatorio de fechamento: parceiros cadastrados, posts publicados, mencoes de tutores, casos de pets registrados via indicacao de parceiro. Usar esse relatorio como base para a campanha em Guaruja no mes seguinte.

**Metrica de sucesso da Semana 4:** 8 parceiros cadastrados, 2 posts de co-branding com media de 200+ interacoes cada, 1 caso documentado de tutor que chegou via parceiro.

---

## KPIs de sucesso

| Metrica | Meta | Prazo | Como medir |
|---|---|---|---|
...
| Engajamento co-post vs post normal | 3x maior | Dia 30 | Comparativo Instagram Insights |
| Custo de aquisicao por parceiro | R$ 0 (sem anuncio pago) | Dia 30 | Sem investimento em midia |

---

## Objecoes esperadas e respostas
...
- [ ] Link direto para cadastro no diretorio (sem formulario longo)
- [ ] Planilha de acompanhamento: pet shop, contato, status, data de follow-up

---

## Conexao com sazonalidade

- **Junho (agora):** Periodo de baixa sazonalidade para pets perdidos. Momento ideal para captar parceiros sem urgencia — o pet shop esta mais tranquilo para conversar.
- **Dezembro a Fevereiro:** Pico de pets perdidos na Baixada Santista (temporada de praias, fogos de Reveillon). Os parceiros captados em junho estarao ativos e treinados para o pico. O ROI da parceria vai aparecer nesse periodo.
- **Carnaval 2027:** Meta de ter 15+ parceiros em toda a Baixada Santista para o primeiro grande pico com rede de parceiros ativa.
